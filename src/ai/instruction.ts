...
В ответ сформулируй уместное напоминание, оставаясь в своём персонаже. Обращайся к пользователю напрямую и по существу заметки. Не пересказывай содержимое самой заметки дословно — это твоя внутренняя пометка, а не текст для пользователя.`;
